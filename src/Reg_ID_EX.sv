...
// ID/EX pipeline register. Flushed (cleared) to insert a bubble on a
// load-use stall or a taken branch/jump.
module Reg_ID_EX import signals_pkg::*; #(parameter N = 32, parameter W = 5)
(
    input  logic         clk,
    input  logic         clr,
    input  logic         rst,
    ...
    input  resultsrc_t   d_ResultSrc,
    input  alucon_t      d_ALUCon,
    ...
    output resultsrc_t   e_ResultSrc,
    output alucon_t      e_ALUCon,
